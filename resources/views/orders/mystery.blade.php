                                    ...
                                    <td class="border-b border-slate-100 dark:border-slate-700 p-3">
                                        <div class="flex flex-nowrap">
                                            ...
                                            <button type="button" data-trigger="js_action_click" data-action="" data-id="{{$order->id}}" data-parent="#js_orderitem_{{$order->id}}"
                                                    class="hidden hover:bg-indigo-600 bg-indigo-500 focus:outline-none focus:ring focus:ring-indigo-200 transition ease-in-out duration-150 flex items-center rounded-md text-white text-sm font-medium p-1 shadow-sm">
