                    ...
                    @foreach($line_items as $item)
						<div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md m-6 flex-1">
							...
							<div class="p-5">
								...
								<a href="{!! route('mysteryBoxCollectProducts', [$order->order_id, $item['product_id'], $item['variant_id']]) !!}" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-indigo-700 rounded-lg hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">
									Collect products
